class OfferTable < UITableViewController
  ...
  def searchBarSearchButtonClicked(searchBar)
    ...
    url = "http://offer-demo.adcrws.com/v1/offers?access_token=#{ENV['ACCESS_TOKEN']}&sort=random&query=#{query}&lat=44.04484&lon=-122.93529"
